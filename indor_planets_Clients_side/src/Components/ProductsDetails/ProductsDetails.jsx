...
const handleClick = (id, quantity) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6  bg-gray-50 dark:bg-gray-50 rounded-xl shadow-2xl shadow-green-200 my-10">
      {/* Back Button */}
      <div className="mb-6">
        <button
        ...
        <div className="flex flex-col justify-start md:w-1/2">
          ...
          <div className="flex items-center gap-4 mb-3">
            ...
            <input
              ...
              className="input border-1 border-amber-400 bg-gray-50 dark:bg-gray-50 w-20 text-amber-500 cursor-target"
            />
          </div>
          ...
          <div className="flex space-x-4">
            <button
              className="btn dark:border-none border-none dark:text-white bg-green-500 cursor-target cursor-pointer text-white flex-grow"
              onClick={() => setShowBuyModal(true)}
            >
              Buy
            </button>
            <button
              className="btn bg-amber-500 dark:border-none border-none cursor-target cursor-pointer text-white flex-grow"
              onClick={() => setShowReviewModal(true)}
            >
              Review
            </button>
            <button
              className="btn dark:border-none bg-red-500 border-none cursor-target cursor-pointer text-white flex-grow"
      ...
      {showBuyModal && (
        ...
        >
          ...
          <p className="mb-4 dark:text-gray-700 text-gray-700 font-bold text-lg">
            Total Amount: ৳{" "}
            {(filterData.price * quantity).toLocaleString("en-BD")}
          </p>
          ...
          <div className="modal-action">
            <button
              className="btn bg-green-500 border-none dark:border-none text-white cursor-target"
              onClick={() =>
      ...
      {showReportModal && (
        ...
        >
          ...
          <div className="modal-action space-x-2">
            <button
              className="btn cursor-target border-none dark:border-none cursor-pointer bg-red-500 text-white"
              disabled={reported}
              onClick={() => {
    ...
    dark:bg-gray-50 bg-gray-50 text-black border"
            ></textarea>
            <div className="modal-action">
              <button
                type="submit"
                disabled={review}
                className="btn cursor-target border-none dark:border-none cursor-pointer bg-amber-500 text-white"
              >
