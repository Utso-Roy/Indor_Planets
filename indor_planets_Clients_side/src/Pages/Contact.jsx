        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <button
                type="submit"
                className="cursor-target dark:border-none border-none cursor-pointer inline-flex items-center justify-center btn px-5 py-3 bg-emerald-600 text-white font-medium shadow hover:bg-emerald-700 active:scale-[.98] transition"
              >
                Send Message
              </button>
            </form>
